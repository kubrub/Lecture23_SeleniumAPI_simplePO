...
public class Test extends DriverSet {
    ...
    public void test() {
        ...
        try {
            ...
            String getPrice = webDriver.findElement(By.xpath("/html/body/app-root/rz-single-modal-window/div[3]/div[2]/rz-shopping-cart/div/ul/li/rz-cart-product/div/div[2]/div/p[2]")).getText();
